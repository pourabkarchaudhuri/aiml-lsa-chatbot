...
search_results = googlesearch.search('who is batman', tld='com', lang='en', tbs='0', safe='off', num=10, start=0, stop=2, domains=None, pause=2.0, only_standard=False, extra_params={}, tpe='', user_agent=None)
